...
class _CurrentState extends State<Current> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder(stream: Firestore.instance.collection('/Patient/${widget.id}/Patient_records').where('ExpiryDate',isGreaterThan: DateTime.now()).snapshots(),builder: (ctx,s){
        if(s.hasData){

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: Text('Profile'),automaticallyImplyLeading: false,actions: [
      IconButton(icon: Icon(Icons.settings), onPressed: (){
        Navigator.of(context).pushNamed('Stting',arguments:widget.routarg);

      }),
    ],),

      body: StreamBuilder(stream: Firestore.instance.collection('Patient').document(widget.routarg).snapshots(),builder: (ctx,pr){
        if(pr.hasData){

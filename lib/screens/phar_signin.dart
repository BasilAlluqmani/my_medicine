...
class SignInPha extends StatefulWidget {
  @override
  _SignInPhaState createState() => _SignInPhaState();
}

class _SignInPhaState extends State<SignInPha> {
                ...
                if (ID == dataDr.data['id'].toString()) {
                  ...
                  if (Passw == dataDr.data['password']) {
                    ...
                    Navigator.of(context)
                        .pushReplacementNamed('Pharmacist', arguments: {'ID':ID,'Hospital':element.documentID});
                  } else
                    print('Wrong Pass');
                } else

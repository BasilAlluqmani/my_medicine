...
class _settingsPState extends State<settingsP> {
  ...
  void Change_password(id){
    DocumentReference documentReference=
    Firestore.instance.
    collection("/Hospitals/${id['h']}/pharmacist").document(id['id']);
                ...
                FlatButton(
                  ...
                  onPressed: (){
                    if(_formKey.currentState.validate()){
                      DocumentReference documentReference=
                      Firestore.instance.collection("/Hospitals/${id['h']}/pharmacist").document(id['id']);
                      Map<String, dynamic> Change_password={"pass":_new_password.text,};
